...
function getMatchToFixtureAndPlay(){
    var matchTeams=[{'Home':null,'Away':null}];
...
function updateFixture(homeTeam,awayTeam,homeGoal,awayGoal){
    ...
    jQuery.each(updateFixtures, function( i, match ){
        if(match.Home == homeTeam.Name && match.Away == awayTeam.Name){
            ...
            updateFixtures[i]={'Home':homeTeam.Name,'Away':awayTeam.Name,'Week':NowWeek,'HomeGoal':homeGoal ,'AwayGoal':awayGoal};
        }
    });
...
function createFixture(){
    ...
    for(var round = 0; round < roundsCount; round++)
    {
        for(var match = 0; match < matchPerRound; match++)
        {
            ...
            FixtureMatch ={'Home':Home, 'Away':Away, 'Week':round+1, HomeGoal:null, AwayGoal:null};
...
function startLeague(){
    Teams=[
        {'Name':'Fenerbahçe','PlayerQuality':16,'Tactics':'Def','Offensive':14,'Defence':17,'FanSupport':8,'Win':0,'Lose':0,'Tie':0,'Pts':0,'Played':0,'GoalDifference':0,'Morale':0,'PredictionsOfChampionship':'soon'},
    
        {'Name':'Başakşehir','PlayerQuality':12,'Tactics':'Off','Offensive':16,'Defence':14,"FanSupport":4,'Win':0,'Lose':0,'Tie':0,'Pts':0,'Played':0,'GoalDifference':0,'Morale':0,'PredictionsOfChampionship':'soon'},
    
        {'Name':'Ankaragücü','PlayerQuality':8,'Tactics':'Off','Offensive':8,'Defence':4,"FanSupport":6,'Win':0,'Lose':0,'Tie':0,'Pts':0,'Played':0,'GoalDifference':0,'Morale':0,'PredictionsOfChampionship':'soon'},
    
        {'Name':'Akhisarspor','PlayerQuality':6,'Tactics':'Def','Offensive':3,'Defence':10,"FanSupport":2,'Win':0,'Lose':0,'Tie':0,'Pts':0,'Played':0,'GoalDifference':0,'Morale':0,'PredictionsOfChampionship':'soon'}
    ];
